...
import { MapPin, Users, Calendar, MessageSquare, Eye, Sparkles, Loader2 } from 'lucide-react'
      ...
      <div className="p-5">
        ...
        <div className="flex gap-2 mb-4">
          <button
            ...
            className={`flex-1 px-4 py-2 rounded-lg font-black border-2 border-black transition-all ${
              activeTab === 'overview'
                ? 'bg-black text-white'
